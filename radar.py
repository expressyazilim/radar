...
st.markdown("""
    ...
    .stSlider > div > div { background: #1a252f !important; }
    .stSlider > div > div > div { background: #7f8c8d !important; }
    ...
    @media (max-width: 768px) {
        .stButton>button { height: 55px !important; font-size: 18px !important; }
...
# --- GİRİŞ KONTROLÜ ---
APP_PASSWORD = "altin2026"  # ŞİFRE DEĞİŞMESİN dedin: burada aynı bırakıyorum
...
AI_REPORTS_FILE = "ai_analiz_raporlari.jsonl"  # jsonl daha sağlam
...
if analiz_butonu:
    ...
    try:
        ...
        st.error("❌ Streamlit Secrets bulunamadı! Settings → Secrets içine CDSE_CLIENT_ID ve CDSE_CLIENT_SECRET ekle.")
        st.stop()
            ...
            try:
                ...
                if res.status_code == 200:
                    ...
                    fig.update_layout(
                        ...
                        height=500,
                        title=dict(text=f"Sentinel-1 SAR Verisi - {cap}m Çap", font=dict(size=18))
                    )
